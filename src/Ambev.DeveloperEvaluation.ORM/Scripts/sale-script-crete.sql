...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260124045916_AddSaleAndSaleItemEntities') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260124045916_AddSaleAndSaleItemEntities') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260124045916_AddSaleAndSaleItemEntities', '8.0.10');
    END IF;
END $EF$;
COMMIT;
